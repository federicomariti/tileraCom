#ifndef __CHANNEL_SIMMETRIC_REFERENCE_AD1_SM_NULL_H__
#define __CHANNEL_SIMMETRIC_REFERENCE_AD1_SM_NULL_H__
 ...
 */
typedef struct ch_sym_ref_ad1_sm_null_t ch_sym_ref_ad1_sm_null_t;

#ifdef CHANNEL_SIMMETRIC_REF_AD1_SM_NULL__TEST
int csra1_sm_null_test_structureSize(void);
#endif 

#ifdef CHANNEL_SIMMETRIC_REF_AD1_SM_NULL__DEBUG
#include <stdio.h>
void csra1_sm_null_debug_printStructuresSize(void);
#endif 
 ...
 */
void
ch_sym_ref_ad1_sm_null_send(ch_sym_ref_ad1_sm_null_t *ch, void *msg);
...
#endif /* __CHANNEL_SIMMETRIC_REFERENCE_AD1_SM_NULL_H__ */
